...
.pink[When its assumptions/requirements are valid], OLS is a powerful and flexible tool for estimating the parameters of a linear model.

--

We must to pay attention to both the

- .b.purple[parameter estimates] $(\hat{\beta}_k)$ that estimate .purple[effects],
- .b.purple[standard errors] $(\widehat{\text{SE}}(\hat{\beta}_k))$ that quantify .purple[uncertainty].

--

If .b.orange[assumptions are violated], OLS can lead us to incorrect conclusions,

- .b.orange[biased] estimates of the parameters,
- .b.orange[incorrect] standard errors,
- .b.orange[wrong] inferences about the parameters.
